package me.kasuki.staffcredits.utilities.cuboid;
...
public class Cuboid implements Iterable<Block>, Cloneable, ConfigurationSerializable {
    ...
    /**
     * Get the north-east corner of the Cuboid.
     *
    ...
    /**
     * Get the south-west corner of the Cuboid.
     *
    ...
    /**
     * Get the south-east corner of the Cuboid.
     *
    ...
    /**
     * Get the north-west corner of the Cuboid.
     *
    ...
    public boolean overlaps(Cuboid other) {
        ...
        // Iterate through the blocks of the current Cuboid
        for (Block block : this) {
            int x = block.getX();
            int y = block.getY();
            int z = block.getZ();

            // Check if the block is within the other Cuboid
